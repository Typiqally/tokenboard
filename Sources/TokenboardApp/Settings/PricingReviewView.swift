    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 14) {
            ...
            Form {
                ...
                reviewRow("Exchange rates", value: content.exchangeRates.joined(separator: "\n"))
                reviewRow("Exchange-rate provenance", value: content.exchangeRateProvenance)
                reviewRow("Current API-equivalent value", value: content.currentKnownValue)
                reviewRow("Candidate API-equivalent value", value: content.candidateKnownValue)
