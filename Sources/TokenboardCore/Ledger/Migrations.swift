public enum Migrations {
    ...
    /// Daily per-model agent activity counters. Existing sources record how far they were already imported, so
    /// history before the upgrade can be counted exactly once by a separate backfill while new lines are
    /// counted as they are scanned.
    public static let v7 = Migration(
        version: 7,
    ...
    public static let all = [v1, v2, v3, v4, v5, v6, v7]
}
