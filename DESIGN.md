...
- Always show the exact preview as `Playing Tokenboard`, a daily-usage detail line, today's compact tokens plus active-hour bucket count, and the static `View on GitHub` action. The preview has one combined VoiceOver label in spoken order.
