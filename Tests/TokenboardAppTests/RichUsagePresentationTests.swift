...
final class RichUsagePresentationTests: XCTestCase {
    ...
    func testApprovedSurfaceDimensionsStayCompactAndRelated() {
        ...
        XCTAssertEqual(TokenboardSurfaceMetrics.companionPanoramaHeight, 224)
        XCTAssertEqual(TokenboardSurfaceMetrics.companionHUDTopPadding, 12)
        XCTAssertEqual(TokenboardSurfaceMetrics.companionHUDSpacing, 8)
        XCTAssertEqual(TokenboardSurfaceMetrics.companionHeaderHeight, 20)
        XCTAssertEqual(TokenboardSurfaceMetrics.companionTopScrimOpacity, 0.84)
        ...
        XCTAssertEqual(TokenboardSurfaceMetrics.companionContentSpacing, 8)
        XCTAssertEqual(TokenboardSurfaceMetrics.companionChartHeight, 144)
        XCTAssertEqual(TokenboardSurfaceMetrics.companionProviderSpacing, 8)
        XCTAssertEqual(TokenboardSurfaceMetrics.companionContentBottomPadding, 8)
        XCTAssertEqual(TokenboardSurfaceMetrics.companionFooterContentOffset, 0)
